...
const TOOL         = "ariel";
const REPO_URL     = "https://github.com/pavelsimo/ariel";
const BREW_TAP     = "pavelsimo/homebrew-tap";
const DESC         = "animate Mermaid diagrams as images and videos";
const COLOR_SCHEME = "ocean"; // teal | ocean | purple | amber
const SITE_BASE    = existsSync("docs/CNAME")
  ? `https://${readFileSync("docs/CNAME","utf8").trim()}`
  : `https://pavelsimo.github.io/ariel`;
